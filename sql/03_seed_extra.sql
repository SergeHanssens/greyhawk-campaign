...
insert into public.monsters (name, ac, hp_dice, thac0, damage, move, alignment, description) values
  -- More humanoids
  ('Goblin Shaman',7,'2',19,'1d6',6,'Lawful Evil','Goblin met clerical magie. Cast als Cleric lvl 2-4. Per stam 1 shaman. Nimmer alleen — beschermd door bodyguards.'),
  ('Orc Chieftain',5,'5',15,'1d8+2',9,'Lawful Evil','Per orc tribe één chieftain (Fighter lvl 5). HD 5+1. STR 18. Vaak met magic weapon van vorige slachtoffer. Lijst-uitvallen-eind van de tribe-pyramide.'),
  ('Hobgoblin Captain',3,'5',15,'1d8+1',9,'Lawful Evil','Officier in hobgoblin leger. Banded mail + shield. Tactisch slim — ranger-like ervaring.'),
  ('Drow Elf',6,'3+1',17,'1d8',12,'Chaotic Evil','Donkere oppervlakte-elf. Cleric of Wizard skills. Magic resistance 50% + 2% per level. Daglicht: -1 to hit. Onderaards in Erelhei-Cinlu.'),
  ('Duergar',3,'2',19,'1d6',6,'Lawful Evil','Grijze dwergen — donkere keldercousins. Enlarge spell + invisibility 1x/dag. Magic resistance 20%. Gehate dwarven kin.'),
  -- More giants
  ('Cloud Giant',-1,'12+2-7',9,'6d4',15,'Neutral','24 ft, 11000 lbs. Levitate at will. Werpt rotsblokken (range 60). Telkens 1d4 chance op musical instrument bezit.'),
  ('Storm Giant',-2,'15+1-7',7,'7d6',15,'Chaotic Good','26 ft. Levitate, lightning bolt 1x/dag. Onderwater-thuis. Schoonheid en intelligentie van mensen, kracht van giants.'),
  -- Undead extra
  ('Mummy',3,'6+3',13,'1d12',6,'Lawful Evil','Wrap-bedekt undead. Zicht alleen veroorzaakt fear (save vs spell of paralyzed 1d4 rondes). Touch: rotting disease (geen healing, langzaam dood). Vuurkwetsbaar.'),
  ('Spectre',2,'7+3',13,'1d8 + 2 levels drain',15,'Lawful Evil','Blauwig glanzende undead. 2 LEVEL DRAIN per touch — devastating. Magic weapons only. Sunlight: vluchten. Bezwaar 7 turn.'),
  ('Banshee',0,'7',13,'1d8',15,'Chaotic Evil','Wail death — wezens binnen 30ft save vs spell of dood. Onmaterieel. Slechts s nachts. +1 magic weapons hit.'),
  ('Lich, Demilich',-2,'9+',9,'touch / dust',6,'Lawful Evil','Lich na duizend jaar. Zelfs schedel kan nog level drain en soul trap doen. Devastating final boss.'),
  -- Demons (Chaotic Evil)
  ('Demon, Type I (Vrock)',0,'8',12,'1d4/1d4/1d8/1d8',12,'Chaotic Evil','Vulturen-demon. 50% MR. Spells: Detect invisible, gate (other vrock 35%). Flight, claws en bite.'),
  ('Demon, Type II (Hezrou)',-2,'9',11,'1d3/1d3/4d4',6,'Chaotic Evil','Pad-achtige demon. 55% MR. Stinking aura - save or weak. Tongue-grab.'),
  ('Demon, Type III (Glabrezu)',-4,'10',11,'2d6/2d6/1d3/1d3/1d4+1',9,'Chaotic Evil','Vier armen — twee scharen, twee menselijke. 60% MR. Power Word: Stun + Mirror Image.'),
  ('Demon, Type IV (Nalfeshnee)',-1,'11',9,'1d4/1d4/2d8',9,'Chaotic Evil','Boar-headed demon-noble. 65% MR. Slow, Talisman, gate.'),
  ('Demon, Type V (Marilith)',-9,'7+7',11,'2/2/2/2/2/2/3d4',12,'Chaotic Evil','Slang-onder met 6 armen. 80% MR. Charm, fear, magic missile, polymorph self. Tactische generaal van de Abyss.'),
  ('Demon, Type VI (Balor)',-2,'8+8',7,'1d4+9 (sword)',6,'Chaotic Evil','Vlam-omhuld krijger. 75% MR. +3 sword + whip pulls victim near. Fireball, telekinesis. Major demon — death whirl op kill.'),
  -- Devils (Lawful Evil)
  ('Devil, Lemure',7,'3',17,'1d3',3,'Lawful Evil','Laagste lawful-evil devil. Bewust niets. Regenerate 1 HP/round. Holy water dmg.'),
  ('Devil, Spinagon',5,'4+1',15,'1d3 + spike',6,'Lawful Evil','Spike-bedekt devil. Throws spikes (range 6/12/18, 1d4 dmg).'),
  ('Devil, Cornugon (Horned)',-2,'10',9,'1d3/1d3/2d4',9,'Lawful Evil','Horned devil. 50% MR. Vlam-aanval, fear gaze, suggestion.'),
  ('Devil, Pit Fiend',-3,'13',7,'5d6 (bite + hug)',9,'Lawful Evil','Generaal van Hell. 65% MR. Spells lvl 8+ caster. Wish 1x/maand. Symbool van pure tyranny.'),
  -- Dragons additional
  ('White Dragon',3,'6',15,'1d6/1d6/2d8',12,'Chaotic Evil','IJsdraak. Cold breath (70 ft cone, 6d6+ dmg). Half-dmg cold creatures. Treasure laag voor dragon.'),
  ('Blue Dragon',2,'9',11,'1d8/1d8/3d8',9,'Lawful Evil','Lightning bolt breath (5x80ft line, 9d6+). Burrows in zand-woestijnen. Telepathie met andere blue.'),
  ('Gold Dragon',-2,'11',9,'1d8/1d8/6d6',12,'Lawful Good','Wijste en machtigste good dragon. Two breath (chlorine + fire). Polymorph, tongues, suggestion. Allies to good.'),
  ('Silver Dragon',0,'10',11,'1d6/1d6/5d6',9,'Lawful Good','Cold breath OR paralysis breath (frost cone of paralysis). Polymorph, tongues. Cloud-dwelling.'),
  -- Beasts extra
  ('Hippogriff',5,'3+3',15,'1d6/1d6/1d10',18,'Neutral','Eagle-horse hybrid. Mountable maar wild. Eet alleen vlees. Mounts voor advanced cavaliers.'),
  ('Pegasus',6,'2+2',17,'1d8/1d8',24,'Chaotic Good','Wit gevleugelde paard. Goede uitlijning — alleen mountable door pure (paladin etc.).'),
  ('Unicorn',2,'4+4',15,'1d8/1d8/1d12',24,'Chaotic Good','Wit paard met regenerative horn. Touch: cure light wounds, neutralize poison. Allows only chaste maidens to touch.'),
  ('Griffon',3,'7',13,'1d4/1d4/2d8',12,'Neutral','Lion-eagle hybrid. Wilde mounts after long taming. Eat horses.'),
  ('Wyvern',3,'7+7',13,'2d8 + sting (poison)',6,'Neutral Evil','Two-legged dragon-cousin. Tail sting: save vs poison or death.'),
  -- Aquatic
  ('Sahuagin',5,'2+2',17,'1d2/1d2/1d4',12,'Lawful Evil','Shark-mensen. Trident + javelins. Frenzy in bloed. Underwater warrior race.'),
  ('Locathah',6,'2',19,'1d6 (weapon)',3,'Neutral','Vis-mensen. Vredevol meestal. Live in coral cities.'),
  ('Kraken',0,'20',7,'5d4 (8 tentacles)',3,'Lawful Evil','Reusachtige inktvis met 8 tentakels en intelligent. 80 ft body. Spell-caster (Magic-User lvl 9). Schrik der oceanen.'),
  -- Misc
  ('Centaur',5,'4',15,'1d6/1d6/2 (weapon)',18,'Neutral Good','Mens-paard hybride. Vredevol meestal. Geweldige bondgenoten in wildernis. 8-12 in groepen.'),
  ('Satyr',5,'5',15,'butt + weapon',12,'Chaotic Neutral','Geit-mens. Pipes can charm (save vs spell), sleep, fear. Hobby: drinking + chasing nymphs.'),
  ('Dryad',9,'2',19,'1d4 (dagger)',12,'Neutral','Boom-nymph. Charm 1x/dag. Cannot leave their tree (dies if tree dies).'),
  ('Naga, Spirit',3,'9',11,'1d3 + poison',12,'Chaotic Evil','Snake-bodied with woman-head. Spell-caster. Charm gaze.'),
  ('Doppleganger',5,'4',15,'1d12',9,'Neutral','Shape-shifter. Mimic any humanoid perfectly. Saves as 10th lvl Fighter. Surprise on 1-4 op d6.'),
  ('Rust Monster',2,'5',15,'rust',18,'Neutral','Touch any iron-equipment: instantly rust to nothing. Magic items get save. Fighter''s nightmare.'),
  ('Gelatinous Cube',8,'4',15,'2d4',6,'Neutral','Transparent ooze 10x10x10ft. Engulfs victim — paralysis + slowly digest. Can carry treasure inside.'),
  ('Gray Ooze',8,'3+3',15,'2d8',1,'Neutral','Looks like wet stone. Eats metal (sword, armor in 1 hit).'),
  ('Black Pudding',6,'10',11,'3d8',6,'Neutral','Devastating blob — splits in two when hit (each smaller). Eats wood, leather, metal. Acid corrosion.'),
  ('Stirge',8,'1+1',19,'1d3 + drain blood',3,'Neutral','Mosquito-bat. After hit: attaches and drains 1d4 HP per round automatically.'),
  ('Mimic',7,'7-10',13,'3d4 + glue',3,'Neutral','Disguised as chest, door, statue. Glue grip = victim cannot withdraw. Surprise on 1-4 op d6.'),
  ('Otyugh',3,'7',13,'1d8/1d8/2d6 + disease',6,'Neutral','Sewer-dweller. Disease + grappling tentacles. Eat trash and adventurers.'),
  ('Roper',0,'10',11,'5d4 + drain str',3,'Chaotic Evil','Cave fungus look. 6 tentakels grip enemies — drains STR until paralysis.'),
  ('Basilisk',4,'6+1',13,'1d10 + petrification gaze',6,'Neutral','Eight-legged lizard. Eye contact = save vs petrification of stone forever.'),
  ('Cockatrice',6,'5',15,'1d3 + petrification',6,'Neutral','Rooster-snake hybrid. Touch save vs petrification.'),
  ('Medusa',5,'6',13,'1d4 (snake hair)',9,'Lawful Evil','Snake-haired woman. Eye contact = stone. Mirror reverse against herself = stone herself.'),
  ('Sphinx, Andro',-2,'12',9,'2d6/2d6',18,'Lawful Neutral','Lion body + man head + wings. Cleric spell-caster lvl 8. Riddles guard treasure.')
on conflict do nothing;
