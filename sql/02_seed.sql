...
insert into public.weapons (name, weapon_type, damage, speed_factor, weight, type, description) values
  -- Swords
  ('Long Sword','Sword','1d8',5,'60','Slashing',
   'Het iconische zwaard van avonturiers, ridders en stadswachten in heel Greyhawk. Een rechte, dubbel-snijdende kling van 36-40 inches met ronde of cruciforme kruisbeschermer. Veelzijdig in één hand, laat een schild in de andere toe. Schade: 1d8 vs Small/Medium, 1d12 vs Large. De standaard om alle andere zwaarden mee te vergelijken. Kosten: 15 gp.'),
  ('Short Sword','Sword','1d6',3,'35','Piercing',
   'Een korte kling van 18-24 inches, ideaal voor gevechten in nauwe gangen, schepen of stedelijke setting. De voorkeur van Halflings en Thieves. Snel (SF 3) en licht (35 oz). Schade: 1d6 vs Small/Medium, 1d8 vs Large. Vaak gedragen als secundair wapen of als parry-blade. Kosten: 8 gp.'),
  ('Bastard Sword','Sword','1d8',6,'100','Slashing',
   'Een hand-and-a-half zwaard, langer dan een long sword maar korter dan een two-hander. Mag éénhandig (1d8) of tweehandig (2d4 vs Small/Med, 2d8 vs Large) gehanteerd worden. Vereist STR 13 voor éénhandig gebruik. Geliefd door Cavaliers en hoge-level Fighters om de tactische flexibiliteit. Kosten: 25 gp.'),
  ('Two-Handed Sword','Sword','1d10',10,'250','Slashing',
   'Het wapen van bersekers en eenzame helden — een enorme 5-6 voet kling die met beide handen gehanteerd moet worden. Schade: 1d10 vs Small/Medium, 3d6 vs Large. Speed Factor 10 maakt het traagst van alle zwaarden, maar de schade compenseert. Geen schild mogelijk. Kosten: 50 gp.'),
  ('Scimitar','Sword','1d8',4,'40','Slashing',
   'Een gebogen, eenzijdig zwaard van Baklunish origine, gewild in de woestijnen van de Bright Lands en bij westerse rovers van de Sea Princes. De krommingscurve geeft snelle slashes maar vermindert thrust-mogelijkheden. Druids mogen scimitar gebruiken (zeldzaam: een metalen wapen). Kosten: 15 gp.'),
  ('Falchion','Sword','1d6+1',5,'90','Slashing',
   'Een breed, kort, gebogen zwaard met machete-achtige profiel. Eenzijdig snijdend, populair bij milities en boeren-rebellen want goedkoop te smeden. Schade: 1d6+1 vs Small/Medium, 2d4 vs Large. Kosten: 14 gp.'),
  ('Rapier','Sword','1d6+1',2,'40','Piercing',
   'Een dunne, lange kling primair bedoeld voor stoten. Snelste zwaard in de game (SF 2). Vooral populair in stedelijke duels en hofintriges in Furyondy en Veluna. Vereist DEX 13 voor optimaal gebruik. Kosten: 15 gp.'),

  -- Axes
  ('Battle Axe','Axe','1d8',7,'70','Slashing',
   'Een gevechtsbijl met enkele snede en kop van ~10 lbs op een 36-inch handvat. De voorkeur van Dwarves: balanceren aanvallen op hoge plekken (orcs, ogres) met devastating cleaves. Schade: 1d8 vs Small/Medium, 1d8 vs Large. Eénhandig. Kosten: 5 gp.'),
  ('Two-Handed Battle Axe','Axe','1d10',9,'150','Slashing',
   'Een zware tweehandige variant met 18-inch snede. Schade: 1d10 vs Small/Medium, 2d6 vs Large. Geliefd door Northern Barbarians van de Frost Barbarians. Kosten: 7 gp.'),
  ('Hand Axe','Axe','1d6',4,'50','Slashing',
   'Kleinere versie, ook werpbaar (range 1/2/3 inches = 10/20/30 feet). Bijzonder geliefd door Dwarves en Halflings als secundair wapen. Schade: 1d6 vs Small/Medium, 1d4 vs Large. Kosten: 1 gp.'),
  ('Throwing Axe','Throwing','1d6',4,'50','Slashing',
   'Speciaal gebalanceerde werpbijl. Range 1/2/3. Vlees in close combat. Schade: 1d6/1d4. Kosten: 1 gp.'),

  -- Bows
  ('Long Bow','Bow','1d8',7,'30','Piercing',
   'Een 6-voet lange boog van eikenhout of yew. Vereist STR voor maximale spankracht. Range: 7/14/21 (70/140/210 ft). Rate of fire: 2 schoten/ronde. Schade: 1d8 vs Small/Medium, 1d6 vs Large. Kan magic arrows gebruiken. De voorkeur van Elves en Rangers. Kosten: 60 gp + arrows.'),
  ('Short Bow','Bow','1d6',6,'15','Piercing',
   'Compactere boog, geschikt voor te paard of in dichte begroeiing. Range 5/10/15 (50/100/150 ft). 2 schoten/ronde. Schade: 1d6/1d6. Kosten: 30 gp.'),
  ('Composite Long Bow','Bow','1d8',7,'20','Piercing',
   'Een verfijnde boog van laminaten hout en hoorn — sterker dan een gewone longbow met dezelfde lengte. Range 6/12/18. Vereist hogere STR maar geeft +1 dmg op high-strength characters. Kosten: 100 gp.'),
  ('Composite Short Bow','Bow','1d6',6,'15','Piercing',
   'Korte composite versie. Vooral gewild door beredene boogschutters van de Bright Desert nomads. Range 5/10/15. Kosten: 75 gp.'),

  -- Crossbows
  ('Light Crossbow','Crossbow','1d4+1',7,'50','Piercing',
   'Een mechanische boog met "stirrup" om te spannen. Geen STR vereist. Range 6/12/18 (60/120/180 ft). Slechts 1 schot per ronde door herlaadtijd. Schade: 1d4+1/1d4+1. Iedere klasse mag crossbow gebruiken — de "anti-Magic-User-stress wapen". Kosten: 35 gp.'),
  ('Heavy Crossbow','Crossbow','1d4+1',10,'140','Piercing',
   'Met windlass mechanisme om te spannen. Range 8/16/24. Slechts 1 schot per 2 rondes. Schade: 1d6+1/1d10. Doorboort plate mail beter dan welk ander missiel-wapen. Kosten: 50 gp.'),
  ('Hand Crossbow','Crossbow','1d3',5,'30','Piercing',
   'Een minuscule, in-de-mouw verbergbare crossbow. Geliefd door Assassins en stadse Thieves. Range 2/4/6. 1 schot per ronde. Schade: 1d3 (vaak met gif gecombineerd voor effectiviteit). Kosten: 300 gp (zeldzaam).'),

  -- Daggers
  ('Dagger','Dagger','1d4',2,'10','Piercing',
   'Het kortste metalen wapen, 6-12 inches. Mag werpbaar (range 1/2/3). Snelste (SF 2) en lichtste van alle melee-wapens. Iedere klasse mag dagger gebruiken — zelfs Magic-Users. Vaak vergiftigd door Assassins. Schade: 1d4/1d3. Kosten: 2 gp.'),
  ('Stiletto','Dagger','1d3',2,'8','Piercing',
   'Verfijnde naald-dunne dagger speciaal ontworpen voor het doorboren van mail. Geen schade tegen volledig pantser maar +1 to hit. Klassiek Assassin-wapen. Kosten: 5 gp.'),

  -- Maces / Hammers / Polearms
  ('Mace','Mace','1d6+1',7,'100','Bludgeoning',
   'Een knot met metalen kop, vaak met flanges. Het standaardwapen van Clerics omdat het stomp is en geen bloed vergiet. Schade: 1d6+1 vs Small/Medium, 1d6 vs Large. Effectief tegen pantserdragende vijanden. Kosten: 8 gp.'),
  ('Morning Star','Mace','2d4',7,'125','Piercing/Bludgeoning',
   'Een spiked mace met steel-bal aan de top. Schade: 2d4/1d6+1. Devastating tegen lichte pantsers. Kosten: 5 gp.'),
  ('Footman''s Flail','Flail','1d6+1',7,'150','Bludgeoning',
   'Kettingbal aan een tweehandig handvat. Negeert deels schild-AC bonus (gaat eromheen). Tweehands. Schade: 1d6+1/2d4. Kosten: 3 gp.'),
  ('War Hammer','Hammer','1d4+1',4,'60','Bludgeoning',
   'Een gespecialiseerde hammer met platte kop voor stomp slaan en spike voor pantser-piercing. Werpbaar (range 1/2/3). Geliefd door Dwarves. Schade: 1d4+1/1d4. Kosten: 2 gp.'),
  ('Spear','Spear','1d6',6,'50','Piercing',
   'Een 6-8 voet houten staf met metalen punt. Werpbaar (range 1/2/3). Vooral massa-leger wapen. Reach: kan tweede rij aanvallen vanuit eerste rij. Schade: 1d6/1d8. Kosten: 8 sp.'),
  ('Halberd','Polearm','1d10',9,'175','Slashing/Piercing',
   'Een tweehandig polearm met axe-blade, spike, en hook op een 6-foot handvat. Veelzijdig: snijden, steken, en ontruiteren. Geliefd door Swiss-stijl infanterie. Schade: 1d10/2d6. Kosten: 10 gp.'),
  ('Pike','Polearm','1d6',13,'180','Piercing',
   'Een extreem lange spear (15-20 voet) voor formatie-gevechten. Reach: aanvalt vanuit derde rij. SF 13 maakt slow. Schade: 1d6/1d12. Kosten: 8 gp.'),
  ('Glaive','Polearm','1d6',8,'75','Slashing',
   'Een snijdend polearm: 18-inch single-edged blade op 7-voet pole. Geliefd in Far East. Schade: 1d6/1d10. Kosten: 6 gp.'),
  ('Quarterstaff','Staff','1d6',4,'40','Bludgeoning',
   'Een eenvoudig 6-voet stuk hardhout. Tweehandig. Toegestaan voor Magic-Users, Monks, Druids en Clerics. Verbazend effectief in juiste handen. Schade: 1d6/1d6. Kosten: 2 sp.'),

  -- Slings, clubs, exotic
  ('Sling','Sling','1d4+1',6,'0','Bludgeoning',
   'Een lederen riem voor het werpen van loden kogels of stenen. Range 5/10/20 (50/100/200 ft). Goedkoop, geliefd door Halflings en herders. Schade: 1d4+1 (steen) of 1d6+1 (loden kogel). Kosten: 5 cp + ammo.'),
  ('Staff Sling','Sling','1d6+1',11,'40','Bludgeoning',
   'Een sling op een staf voor extra hefboomwerking. Veel grotere range maar SF 11. Range 6/12/18. Schade: 1d6+1/1d6+1. Kosten: 5 sp.'),
  ('Club','Club','1d6',4,'30','Bludgeoning',
   'Het meest primitieve wapen — een stuk hout. Werpbaar (range 1/2/3). Iedere klasse mag club gebruiken. Schade: 1d6/1d3. Kosten: 0 gp (gratis te vinden).'),
  ('Light Pick','Pick','1d4+1',4,'30','Piercing',
   'Een kleine pick met spike-kop, ontworpen om pantser te doorboren. Eénhandig. Schade: 1d4+1/1d4. Kosten: 1 gp.'),
  ('Heavy Pick','Pick','1d6+1',6,'60','Piercing',
   'Tweehandige variant. +1 dmg vs plate. Schade: 1d6+1/2d4. Kosten: 4 gp.'),
  ('Whip','Whip','1d2',8,'20','Slashing',
   'Een lederen of getouwde whip. Reach 10ft. Lage schade maar kan ontwapenen, struikelen, of een wezen vastgrijpen. Geliefd door slave-drivers en circus-trainers. Schade: 1d2/1. Kosten: 1 gp.'),
  ('Net','Exotic','0',10,'100','Special',
   'Een werpnet om vijand te verstrikken. Range: small. Vereist STR check om los te komen. Geliefd door Roman-stijl gladiators (retiarius). Kosten: 5 gp.'),
  ('Lasso','Exotic','0',10,'10','Special',
   'Een touw met running noose. Range 1/3/5. Bij hit: doelwit moet save vs paralyzation of wordt vastgegrepen. Geliefd door cowboys en monster-tamers. Kosten: 1 gp.'),
  ('Blowgun','Exotic','1',5,'10','Piercing',
   'Een holle pijp die kleine vergiftigde naalden afschiet. Range 1/2/3. Schade: 1 hp (de gif is wat doodt). Geliefd door jungle-tribes en stedelijke Assassins. Kosten: 5 gp.')
...
insert into public.items (name, category, weight, cost, description) values
  -- Adventuring gear
  ('Backpack','gear','20','2 gp',
   'Lederen rugzak met dubbele schouderriemen en heuptouwtjes. Capaciteit ~30 lbs zonder sukkelen, max 50 lbs. Gebruikt voor bivak-uitrusting tijdens reizen. Standaard zonder, geen avonturier vertrekt.'),
  ('Sack, Large','gear','15','2 sp',
   'Burlap of grof linnen zak. Capaciteit 30 lbs, makkelijk droppen.'),
  ('Sack, Small','gear','5','5 cp','Klein zakje voor losse muntjes en juweeltjes.'),
  ('Bedroll','gear','50','1 sp',
   'Slaaprol met deken en kussen. Beschermt tegen koude grond — onmisbaar in wildernis.'),
  ('Tinderbox','gear','10','5 sp',
   'Vuurslag met flint, staal en zwavel-stokjes. 1d4+1 rondes om vuur te ontsteken in optimale omstandigheden.'),
  ('Torch','light','10','1 cp',
   '6 turns brandend (60 minuten). Helder licht 30ft, schemer 60ft. Kan als wapen (1d4 dmg + 1 fire). Kan vampires en undead afschrikken.'),
  ('Lantern, Hooded','light','20','7 gp',
   'Brandt 4 uur op 1 fles olie. Helder licht 30ft, schemer 60ft. Hood om licht te concealmen tot smal stralen. Onmisbaar in dungeons.'),
  ('Lantern, Bullseye','light','30','12 gp',
   'Lantaarn met directionele lens. 60ft cone helder licht. Vooral voor verkennen lange gangen of buiten in nacht.'),
  ('Oil, Flask','gear','10','1 gp',
   'Brandstof voor lantaarn (4 uur). Gebroken op vloer + ontstoken = 2d6 vuur, persistent 2 rondes. Worpgranaat-wapen tegen ongehurde vijanden.'),
  ('Holy Water (vial)','holy','10','25 gp',
   'Water gewijd door cleric ceremonie. Tegen ondoden of buitenwereldse wezens: 2d4 dmg bij contact (worpvial of besprenkelen). Onmisbaar tegen vampires.'),
  ('Holy Symbol, Wooden','holy','5','1 gp',
   'Houten symbol van cleric''s godheid. Vereist voor Turn Undead en sommige spreuken. Dragend slechts één.'),
  ('Holy Symbol, Silver','holy','10','25 gp',
   'Zilveren versie. Verplicht voor priester in betere kerken; ook werkt als zilverwapen tegen lycanthropes. Beter werkzaam tegen ondoden (sommige DMs +1).'),
  ('Spellbook (blank)','gear','30','15 gp',
   'Lege spellbook met 100 pages. Magic-users moeten spreuken in spellbook hebben om te memoriseren. Verlies = verlies van toegang tot spreuk tot research opnieuw.'),
  ('Spell Component Pouch','gear','20','5 gp',
   'Bevat losse componenten voor verbale spreuken (zand, bonen, kristal stukjes). Vereist voor M voltrekken op level 1+ M-U/Cleric spreuken die "M" component vereisen.'),
  ...
  ('Sling Stones (5)','gear','5','—',
   'Vijf rondige stenen of loden kogels voor sling. Vrij oppikbaar als steen.'),
  ('Whetstone','gear','10','2 cp','Polijst en scherpt wapens. Vereist voor onderhoud na zware combat.'),
  ('Helmet','armor','45','10 gp',
   'Stalen of bronzen helm. Vereist voor full plate mail effect — zonder helmet -1 AC. Tegen head-shots = 50% kans op pull.'),
  ...
  ('Ale, Mug','food','—','2 cp','Standaard tavern-ale.'),
  ...
  ('Ring of Protection +1','magic','—','10000 gp','+1 AC en +1 saves. Stapelt niet met armor magie.'),
  ('Ring of Invisibility','magic','—','30000 gp','Bij wens invisible. 6 charges per dag of altijd-aan? DM-keuze.'),
...
insert into public.monsters (name, ac, hp_dice, thac0, damage, move, alignment, description) values
  ('Goblin','6','1-1','20','1d6','6','Lawful Evil',
  ...
  ('Hobgoblin','5','1+1','18','1d8 (or weapon)','9','Lawful Evil',
  ...
  ('Orc','6','1','19','1d8 + race weapon','9','Lawful Evil',
  ...
  ('Bugbear','5','3+1','16','2d4 (or weapon +1)','9','Chaotic Evil',
  ...
  ('Kobold','7','1-1','20','1d4 (or weapon)','6','Lawful Evil',
  ...
  ('Gnoll','5','2','18','2d4 (or weapon)','9','Chaotic Evil',
  ...
  ('Skeleton','7','1','19','1d6','12','Neutral',
  ...
  ('Ghoul','6','2','19','1d3/1d3/1d6','9','Chaotic Evil',
  ...
  ('Wight','5','4+3','15','1 + level drain','12','Lawful Evil',
  ...
  ('Wraith','4','5+3','15','1d6 + level drain','12 / 24 fly','Lawful Evil',
  ...
  ('Vampire','1','8+3','12','1d6+4 + 2 levels drain','12 / 18 fly','Chaotic Evil',
  ...
  ('Lich','0','11+','9','1d10 + paralysis touch','6','Lawful/Chaotic Evil',
  ...
  ('Giant Rat','7','1d4 hp','20','1d3','12','Neutral',
   'FREQUENCY: Common · NO. APPEARING: 5-50 · TREASURE: K · ALIGNMENT: Neutral. Reusachtige rat (1.5 ft+ tail). Komt in groepen — een swarm kan een avonturier overweldigen. 5% kans op disease bij hit (save vs poison of -1d6 STR per dag tot remove disease).'),

  ('Giant Centipede','9','1/2 hp','20','1','12','Neutral',
   'FREQUENCY: Common · NO. APPEARING: 1-12 · TREASURE: nil · ALIGNMENT: Neutral. 1ft pootloosige creep. Bite vergiftig (save vs poison of paralysis 2d6 rondes — geen dood, maar in een zwerm gevaarlijk).'),

  ('Giant Spider','4','4+4','15','1d8 + poison','3 (Web 12)','Chaotic Evil',
   'FREQUENCY: Uncommon · NO. APPEARING: 1-4 · TREASURE: C · ALIGNMENT: Chaotic Evil. 7-foot leg-span. Bite poison: save vs poison -2 of dood. Spinnen webben in geometrische patronen. Drop-attack from ceiling: surprise on 1-4 op d6. Mannelijke vooral kleiner.'),

  ('Owlbear','5','5+2','15','1d6/1d6/2d6 + hug','12','Neutral',
   'FREQUENCY: Uncommon · NO. APPEARING: 1-4 · TREASURE: C · ALIGNMENT: Neutral. Magisch hybride (ooit een conjurer experimenteerde). Massief beer-uil monster, 8 ft tall, 1500 lbs. Twee klauwen + beet. Als beide klauwen treffen: bear-hug voor extra 2d8. Eten alles — incl. unsuspecting parties.'),

  ('Troll','4','6+6','13','5/5/8 + regen','12','Chaotic Evil',
  ...
  ('Ogre','5','4+1','17','1d10 (or huge weapon)','9','Chaotic Evil',
   'FREQUENCY: Uncommon · NO. APPEARING: 1-12 · TREASURE: M (Q ×3) · ALIGNMENT: Chaotic Evil. 9-10 ft hoog, 600-650 lbs. Knottenhoofd. Stupid maar krachtig. Vechten met zware wapens (clubs, +6 dmg variant). Eten alles — vooral mensen en dwarfs. Komen vaak met Hill Giants of Trolls voor.'),

  ('Hill Giant','4','8+1-2','12','2d8 (or weapon)','12','Chaotic Evil',
   'FREQUENCY: Rare · NO. APPEARING: 1-8 · TREASURE: D · ALIGNMENT: Chaotic Evil. 16 ft tall, 1100 lbs, langste haar bedekt. Werpt rotsblokken (range 8/16/24, 2d8 dmg). Vechten met massive clubs of weapons. Soms met dire wolves als pets.'),

  ('Stone Giant','0','9+1-3','11','3d6 (or weapon)','12','Neutral',
   'FREQUENCY: Rare · NO. APPEARING: 1-8 · TREASURE: D · ALIGNMENT: Neutral. 12 ft, slank, harige skin als steen. Werpt rotsblokken (range 30, 3d10 dmg). Catch incoming rocks 90% kans (terugwerpen!). Cave-dwellers, oddly artistic.'),

  ('Frost Giant','4','10+1-4','9','2d10','12','Chaotic Evil',
   'FREQUENCY: Rare · NO. APPEARING: 1-6 · TREASURE: E · ALIGNMENT: Chaotic Evil. 18 ft, 2800 lbs, zware blanke barbarian look. Werpt boulder/ice (range 6/12/24, 2d12 dmg). Half dmg van cold attacks. Vrezen vuur. Berserk warriors.'),

  ('Fire Giant','3','11+1-4','9','5d6','12','Lawful Evil',
   'FREQUENCY: Rare · NO. APPEARING: 1-6 · TREASURE: E · ALIGNMENT: Lawful Evil. 18 ft, 7000 lbs, ebony skin. Werp magma/rocks (range 30 ft, 5d6 dmg). Immuun voor fire. Half dmg van fire weapons. Lederen smiths en blacksmiths van legendarische skill.'),

  ('Wolf','7','2+2','17','1d4+1','18','Neutral',
   'FREQUENCY: Common · NO. APPEARING: 2-12 · TREASURE: nil · ALIGNMENT: Neutral. Roedeldier — alpha leidt strategie. Run-down prey. Vrezen vuur en flame.'),

  ('Dire Wolf','6','3+3','16','2d4','18','Neutral',
   'FREQUENCY: Uncommon · NO. APPEARING: 2-20 · TREASURE: nil · ALIGNMENT: Neutral. Reuze wolf — schouderhoogte 4-5 ft. Often as mounts voor goblinoid races.'),

  ('Brown Bear','6','5+5','15','1d6/1d6/1d8','12','Neutral',
   'FREQUENCY: Common in forests · NO. APPEARING: 1-2 · TREASURE: nil · ALIGNMENT: Neutral. Grizzly-grade. Hug for 2d6 extra dmg na 2 succesvolle klauwen.'),

  ('Polar Bear','6','8+8','12','1d10/1d10/2d6','12','Neutral',
   'FREQUENCY: Uncommon · NO. APPEARING: 1-2 · TREASURE: nil · ALIGNMENT: Neutral. Grootste bear. Arctic regions. Hug 3d6.'),

  ('Lion','6/5','5+2','15','1d4/1d4/1d10','12','Neutral',
   'FREQUENCY: Uncommon · NO. APPEARING: 1-8 (pride) · TREASURE: nil · ALIGNMENT: Neutral. Surprise hunter, leap-attack +1 to hit, twee paw + bite. Females hunt, males defend.'),

  ('Tiger','6','5+5','15','1d4/1d4/1d10','12','Neutral',
   'FREQUENCY: Rare · NO. APPEARING: 1-2 · TREASURE: nil · ALIGNMENT: Neutral. Solitary jungle hunter. Surprise on 1-4 op d6. Klimt bomen.'),

  ('Black Dragon (small)','2','7','14','1d4/1d4/3d6','12 / 24 fly','Chaotic Evil',
   'FREQUENCY: Rare · NO. APPEARING: 1 · TREASURE: F (in lair) · ALIGNMENT: Chaotic Evil. Sub-adult black dragon. Acid breath (60ft x 5ft line, 7d6+ dmg, save half). Acidic spit. Lives in stagnant swamp lairs. Speech, magic use vanaf adult age. Sleep ½ time. Treasure-hoarder.'),

  ('Red Dragon (huge)','-1','11+11','9','1d10/1d10/5d6','9 / 24 fly','Chaotic Evil',
  ...
  ('Green Dragon (large)','2','9','11','1d6/1d6/2d10','9 / 24 fly','Lawful Evil',
   'FREQUENCY: Rare · NO. APPEARING: 1 · TREASURE: H · ALIGNMENT: Lawful Evil. Forest dweller. Chlorine gas breath (50ft x 40ft cloud, 9d6+ dmg). Cunning, manipulative, gebruikt charm magic. Eet alles vegetarisch + voorkeur voor elves.'),

  ('Mind Flayer','5','8+4','11','2-8 + 4 tentacles','6 / 12 swim','Lawful Evil',
  ...
  ('Beholder','0/2/7','45-75 hp','9','2d4 bite + 10 eye-rays','3 fly','Lawful Evil',
